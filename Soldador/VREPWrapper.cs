...
namespace Soldador
{
    public static class VREPWrapper
    {
        ...
        [DllImport("remoteApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public extern static simx_error simxClearFloatSignal(int clientID, string signalName, simx_opmode opmode);

        [DllImport("remoteApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public extern static simx_error simxPauseCommunication(int clientID, char pause);

        [DllImport("remoteApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public extern static simx_error simxCopyPasteObjects(int clientID, int objectHandles, int objectCount, out  int newObjectHandles, out int newObjectCount, simx_opmode opmode);

        [DllImport("remoteApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public extern static simx_error simxSetObjectPosition(int clientID, int objectHandle, int relativeToObjectHandle, float[] position, simx_opmode operationMode);

        [DllImport("remoteApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public extern static simx_error simxRemoveObject(int clientID, int objectHandle, simx_opmode opmode);
